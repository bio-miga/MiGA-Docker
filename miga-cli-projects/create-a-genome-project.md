...
Log in and start MIGA CLI using the approriate method for a (**Starting & Stopping MiGA Docker**), MiGA on a cluster (**Starting & Stopping MiGA Docker**), or on AWS (**Setup a MiGA Instance**).  
